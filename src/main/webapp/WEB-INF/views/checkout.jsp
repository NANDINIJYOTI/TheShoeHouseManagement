...
<html>
<head>
<Body background ="https://i.pinimg.com/236x/0e/0f/3c/0e0f3c803d776300006279a6b591ef45--sexy-sandals-sexy-heels.jpg">
 <meta charset="UTF-8">
    <meta name="viewport"
            ...
            <div class="col-lg-8 mb-4">
                ...
                <div class="card wish-list pb-1">
                    <div class="card-body">
                        ...
                        <h5 class="mb-2" style="color:red">Billing details</h5>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                                <div>
                                    <strong style="color:red">The total amount of</strong>
