...
<div class="container"style="background-color:grey;">
			<h3 style="color:Yellow"><b>Become a Member of The Shoe House and Update your Fashion Style.</b></h3>
			<form action="/register/save" method="post" >
				<label for="usrname"><b>Email Id </label>
				...
				<input name="dateOfBirth" type="text" 
					id="dateOfBirth" required="required" placeholder="Date of Birth YYYY/MM/DD"/></b>
