	...
	<table class ="table table-striped" border="1" width="100%" >  
		...
		<c:forEach  var="product" items="${products}">
			...
			<tr>
				...
				<td><a href="${editLink}"class=" btn btn-primary ">Edit</a></td>  
				<td><a href="${deleteLink}" onclick="if (!('are you sure you want to delete this todo?'))) return false"class=" btn btn-danger ">Delete</a></td>
			</tr>  
